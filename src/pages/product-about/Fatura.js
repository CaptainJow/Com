  ...
  <div className='row justify-content-between align-items-center'>
    <div className='col-lg-8 col-12'>
      <div className='company-info-wrap align-items-center'>
        ...
        <div className='company-overview'>
          <h2 className='display-5 fw-bold'>Fatura Hub</h2>
    ...
    <div className='col-lg-3 col-12'>
      <div className='action-btns mt-4 mt-lg-0 mt-xl-0'>
        <Link to='#' className='btn btn-outline-light' onClick={() => openInNewTab('https://faturahub.com/')}>
          open website
        </Link>
      </div>
    </div>
